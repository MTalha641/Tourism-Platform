...
const locations = [
    {
        ...
        title: "Machu Picchu, KPK",
        description: "Explore the ancient Inca citadel nestled in the Andes mountains. Experience the best lakes in the KPK and enjoy your vacations to the fullest.",
        price: 2499,
